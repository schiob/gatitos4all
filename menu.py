...
class menu:
	def eligeGato():
		...
		print("0: Salir");
		gato = int(input(""));
		if gato == 1 : webbrowser.open(menu.gatoRandom());
		elif gato == 2: webbrowser.open(menu.gatoFilter());
		elif gato == 3: webbrowser.open(menu.gatoGifRandom());
		elif gato == 4: webbrowser.open(menu.gatoRandomConTexto());
		elif gato ==5: webbrowser.open(menu.gatoCustomTexto());
		elif gato ==6: webbrowser.open(menu.gatoEtiquetaTexto());
		return gato;
	def gatoRandom():
